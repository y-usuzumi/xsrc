...
import { parseFile } from "xsrc/schema/parser";
import { parseParameterizedUrl, ITSArg, TSClass, TSImport, TSMethod, TypeScriptGen } from "xsrc/schema/gen/typescript";
...
describe("TSClass", function () {
    describe("render", function () {
        it("frame should be fine", function () {
            ...
            const methodGet = new TSMethod(
                "http://www.baidu.com/", "get", "get",
                [{name: "id", type: "number"}], [],
            );
